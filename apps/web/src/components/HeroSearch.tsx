...
export const HeroSearch: React.FC<HeroSearchProps> = ({ className = '' }) => {
  return (
    <div className={`bg-white rounded-2xl shadow-2xl p-4 md:p-6 max-w-4xl mx-auto ${className}`}>
      <div className="flex flex-col md:flex-row gap-3 md:gap-4">
        <div className="flex-1 relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-4 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent text-gray-900 h-14 md:h-auto placeholder-gray-400"
          />
        </div>
        <Link href="/search" className="block">
          <Button
            size="lg"
            className="w-full md:w-auto px-8 md:px-10 h-14 md:h-auto flex items-center justify-center shadow-md hover:shadow-lg transition-shadow"
          >
